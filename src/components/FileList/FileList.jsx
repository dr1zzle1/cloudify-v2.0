...
import { setCurrentDir, setCurrentDirName, setFiles } from '../../reducers/fileReducer'
import File from '../File/File'
import Preloader from '../Preloader/Preloader'
import './FileList.scss'

const FileList = () => {
  const { files, currentDir, rootDirs, dirStack, isLoading, currentDirName } = useSelector((state) => state.files)

  const dispatch = useDispatch()

  const backClickHandler = () => {
    const [backDirId, backDirName] = dirStack.pop()
    dispatch(setFiles([]))
